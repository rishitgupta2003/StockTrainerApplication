...
def index():
    ...
    return render_template('home.html' , amount = (str)("{:.2f}".format(session['amount'])) , username = session['username'] , shares = shares_existing)
...
def buyShare(stock_symbol):
    ...
    return render_template('share-buy.html', plot=plot_data(stock_symbol) , msg = msg , price = (str)("{:.2f}".format(currentPrice(stock_symbol))) , SS = stock_symbol , stock_symbol = stock_symbol)
...
def sellShare(stock_symbol):
    ...
    return render_template('share-sell.html' , msg = msg , plot = plot_data(stock_symbol) , price = (str)("{:.2f}".format(currentPrice(stock_symbol))) , stock_symbol = stock_symbol , SS = stock_symbol)
